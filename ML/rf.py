...
def jho(feat, label, opts):
    ...
    # train model
    mdl     = RandomForestClassifier(n_estimators = num_tree)
    ...
    print("Accuracy (RF_HO):", 100 * acc)
    
    rf = {'acc': acc, 'con': confmat, 'r': report}
...
def jkfold(feat, label, opts):
    ...
    print("Accuracy (RF_K-fold):", 100 * acc)
